...
const NAME_BARE_STOPLIST_BUNDLED: ReadonlySet<string> = new Set([
  ...
  '오전반', '오후반',
  '하루의', '하루는', '하루도', '하루만',
  // 학문 분야·전공명 (NER이 SURNAME+GIVENNAME으로 잘못 라벨링하는 케이스 — HWPX 강연자 서류 등)
  '심리학', '사회학', '경제학', '경영학', '행정학', '회계학', '통계학',
  '인문학', '윤리학', '정치학', '교육학', '논리학', '언어학',
  '물리학', '생물학', '지리학', '지질학', '천문학',
  '국문학', '영문학', '간호학', '인류학', '고고학', '해양학', '환경학',
  // v1.5 — NPO 결산공시/기부금명세서 양식 일반명사. sample/ QA에서 person_name FP 950건+ 확인.
  // mergeSpans가 regex 우선이라 모델 설치 사용자에게도 직접 영향 — 검토 다이얼로그 노이즈 차단.
  '지급처', '지급을', '지급의', '지급이', '지급된', '지급할', '지급한', '지급하', '지급액',
  '전입액', '전출액', '전입금', '전출금',
  '장학금', '장학생', '장학회',
  '장애인', '장애의', '장애를', '장애로',
  '정규직', '비정규', '계약직', '임시직',
  ...
  '오렌지',
  // v1.6.2 — 브랜드 핵심어. 사용자 보고: "오렌지 임팩트를 창출하는 임팩트 - 조성도 …"에서
  // "임팩트"가 성씨 "임" + 2자("팩트")로 NAME_BARE 매치되어 person_name FP (실제 인명은 "조성도").
  '임팩트',
